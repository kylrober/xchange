...
export default function App() {
  ...
  const users = {
    ...
    four: {id: 4, thumbnail_url: 'https://i0.wp.com/www.mobileworldlive.com/wp-content/uploads/2015/10/Dorsey-iamge.png?fit=550%2C532&ssl=1'},
  }
  ...
  return (
    <div>
      ...
      <PendingTrades changeView={changeView} userData={thisUser}/>
    </div>
  );
}
